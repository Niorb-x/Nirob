            ...
            return {
                on: function (n, i, r, u) {
                    void 0 === u && (u = R),
                        t(n, function (n, t) {
                            (o[n] = o[n] || []),
                                k(o[n], { i: n, r: i, t: t, u: u, n: r }).sort(
                                    function (n, t) {
                                        return n.u - t.u;
                                    }
                                );
        ...
        var _t = Object.freeze({
                ...
                Layout: function (n, t, i) {
                    ...
                    function b() {
                        var n = h(0);
                        return (
                            (n && parseFloat(C(n.slide, s("marginRight")))) || 0
                        );
                    }
                    return {
                        mount: function () {
